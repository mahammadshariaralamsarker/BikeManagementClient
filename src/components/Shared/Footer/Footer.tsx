...
const Footer = () => {
  return (
    <footer className="bg-secondary mt-10 lg:mt-20">
      <MyContainer>
        <div className="space-y-8  py-16 lg:space-y-16">
          ...
          <div className="grid grid-cols-1 gap-8 border-t border-overlyBg/50 pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16">
            <div>
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <FooterLink fLink="#" fTitle="Bikehaben@info.com" />
          ...
          <p className="text-xs text-overlyBg/50">
            &copy; 2025. Bike Haven. All rights reserved.
          </p>
        </div>
      </MyContainer>
    </footer>
